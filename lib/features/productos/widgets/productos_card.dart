              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 5),
                    Text("Categoria: ${producto.categoriaMostrada}"),
                    const SizedBox(height: 5),
                    Text("Precio: \$${producto.precioUnidad.toStringAsFixed(0)}", style: const TextStyle(color: Colors.green, fontWeight: FontWeight.bold))
                  ],
                ),
              ),
              if(rol == 1 || rol == 2)
